...
public:
  IMM_UKF(int id, std::vector<std::string> &model, int state_v, int mea_v,
          Eigen::MatrixXd &P, std::vector<Eigen::MatrixXd> Q,
          std::vector<Eigen::MatrixXd> R,
          Eigen::MatrixXd &interact_probablity) {
    track_id_ = id;
  ...
  void IMM_Initialization(Eigen::VectorXd &Z, float time, float velo,
                          float angles);
  ...
  void UpdateProbability(std::vector<Eigen::VectorXd> &Z,
  ...
  void Process(std::vector<Eigen::VectorXd> &Z, const Eigen::VectorXd &beta,
